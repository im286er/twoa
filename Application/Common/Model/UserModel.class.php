 ...
 * @Last Modified time: 2017-07-19 10:55:24
 */
...
class UserModel extends Model{
	 ...
	 * @return [type]                    [description]
	 */
	function show_director($place_department,$place_group=true){
		if($place_group==true){
